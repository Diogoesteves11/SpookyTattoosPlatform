...
public class PiercingRepository : IPiercingRepository
{
    private readonly SpookyTattoosDbContext _dbContext;

    public PiercingRepository(SpookyTattoosDbContext dbContext)
    {
        _dbContext = dbContext;
    }

    public async Task<Piercing?> GetByIdAsync(int id)
    {
    ...
    {
        await _dbContext.Piercings.AddAsync(piercing);
    }
